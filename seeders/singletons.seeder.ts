...
registerSeeder({
  ...
  async up(client: SanityClient) {
    ...
    await client.createOrReplace({
      ...
      contributions: [
        {_key: key(), title: 'LinkedIn', description: 'Share monthly updates tracking my journey toward becoming a Software Engineer at Google.', url: 'https://www.linkedin.com/in/samabdullaev/', tag: 'SOCIAL'},
        {_key: key(), title: 'UzTech IT Society (UK)', description: 'Organise events, coordinate training, contribute to projects, and lead initiatives.', url: 'https://t.me/UzTechUK', tag: 'COMMUNITY', channelName: '@UzTechUK', channelStatus: 'Active community', activities: ['Events', 'Training', 'Projects']},
        {_key: key(), title: 'GitHub', description: 'Build and maintain personal projects to showcase my coding skills.', url: 'https://github.com/samabdullaev', tag: 'CODE'},
        {_key: key(), title: 'Publink', description: 'Publish mentorship articles in Uzbek on technology, education, and personal growth.', url: 'https://publink.uz/profile/samandar-abdullaev', tag: 'WRITING', subtitle: 'Uzbek mentorship'},
        {_key: key(), title: 'Medium', description: 'Write blogs on studying abroad, self-improvement, and technology.', url: 'https://samabdullaev.medium.com/', tag: 'WRITING'},
        {_key: key(), title: 'LeetCode', description: 'Solve coding problems and share solutions in Python, MySQL, and JavaScript.', url: 'https://leetcode.com/samabdullaev', tag: 'PRACTICE'},
      ],
      hobbies: [
