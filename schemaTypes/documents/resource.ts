...
export default defineType({
  ...
  title: 'Resource',
  type: 'document',
  description: 'A single external resource — a tool, app, library, or service that links straight off-site. Add one of these whenever you find something useful, then add it under any Resource Topic.',
  fields: [
